    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getActivity(),"Worked",Toast.LENGTH_LONG).show();

                startActivity(new Intent(getActivity(),createProfile.class));
            }
        });
        TextView take_to_login=(TextView)view.findViewById(R.id.login_option);
                take_to_login.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        FragmentManager fragmentManager=getActivity().getSupportFragmentManager();
                        fragmentManager.beginTransaction().replace(R.id.contain_fragment,new login_fragment())
